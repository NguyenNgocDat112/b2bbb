      ...
      <div className="max-w-[1440px] mx-auto h-[56px] md:h-[64px] px-2 md:px-4 lg:px-6 flex items-center justify-between w-full gap-2 md:gap-4 lg:gap-6 relative z-50 bg-white">
        ...
        <div className={`items-center shrink-0 ${isMobileSearchOpen ? 'hidden sm:flex' : 'flex'}`}>
          <Link
            ...
            aria-label="VLXD Nguyễn Vinh Home"
          >
            <div className="flex items-center justify-center p-1.5 rounded-full group-hover:bg-gray-100 transition-colors text-[#e60023]">
              <Building2 className="w-[18px] h-[18px] md:w-[20px] md:h-[20px]" />
            </div>
            <span className="text-[#e60023] font-bold text-[16px] md:text-[17px] tracking-tight mr-1">
              VLXD Nguyễn Vinh
            </span>
          </Link>
        </div>
        ...
        <div className={`items-center shrink-0 gap-2 md:gap-4 ${isMobileSearchOpen ? 'hidden sm:flex' : 'flex'}`}>
          ...
          <div className="flex items-center gap-2">
            <Link href="/login" className="flex items-center justify-center bg-[#e60023] text-white font-semibold rounded-full px-3 md:px-4 h-9 md:h-10 hover:bg-[#ad081b] transition-colors text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ad081b] focus-visible:ring-offset-2 whitespace-nowrap">
              Đăng Nhập
            </Link>
