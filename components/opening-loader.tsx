...
export function OpeningLoader() {
  ...
  if (progress > 15 && progress <= 35) {
    ...
    loadingPhaseText = "VẬT LIỆU NGUYỄN VINH SẴN SÀNG BỀN VỮNG CÙNG CÔNG TRÌNH!";
  }
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-8 z-10 my-auto">
            ...
            <div className="flex flex-col items-center text-center gap-3 max-w-md px-4">
              <h1 className="font-serif font-black text-2xl sm:text-3xl md:text-4xl tracking-[0.1em] text-[#cc1a26] overflow-hidden flex flex-wrap justify-center gap-x-[0.2em] gap-y-1">
                {"VLXD NGUYỄN VINH".split(" ").map((word, wordIdx) => (
