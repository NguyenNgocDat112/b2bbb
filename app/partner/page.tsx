...
export const metadata: Metadata = {
  title: "Đăng Ký Đối Tác Phân Phối Sỉ - Chiết Khấu Hấp Dẫn | Phú Khang",
  description: "Trở thành đối tác chính thức phân phối vật liệu xây dựng cao cấp của Phú Khang. Chính sách chiết khấu vượt trội từ 15% - 35%, vận chuyển tận công trình 24/7.",
  keywords: [
    "đăng ký đối tác",
